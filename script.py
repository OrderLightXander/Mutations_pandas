...
@click.command()
@click.option('--input_csv', help='path to csv file') #'genomes.csv'
@click.option('--out_vis', help='path to output pdf visualization') #'plot.pdf'
@click.option('--out_csv', help='path to output csv file') #'out.csv'
@click.option('--searched_domain', help='Searched domain') #'ACCCT'
@click.option('--reference_id', help='Referenced id of genome') #'M_AURIS_581117'
